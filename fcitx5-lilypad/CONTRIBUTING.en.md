...
# Contributing to fcitx5-lilypad

Thank you for your interest in contributing to the fcitx5-lilypad project! This document guides you on how to participate in project development.
...
```bash
git clone https://github.com/yourusername/fcitx5-lilypad.git
cd fcitx5-lilypad
git remote add upstream https://github.com/LilypadInputMethod/fcitx5-lilypad.git
```
