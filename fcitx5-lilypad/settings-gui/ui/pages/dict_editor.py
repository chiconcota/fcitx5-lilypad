...
"""
Dictionary Editor Page. Edits lilypad-dict-table.conf.
...
class DictEditorPage(BaseEditorPage):
    """UI for editing Lilypad dictionary."""
    ...
    def _get_global_dict_path(self) -> str:
        ...
        paths = [
            "/usr/share/fcitx5/lilypad/vietnamese.cm.dict",
            "/usr/local/share/fcitx5/lilypad/vietnamese.cm.dict",
        ]
        for p in paths:
            if os.path.exists(p):
                return p
