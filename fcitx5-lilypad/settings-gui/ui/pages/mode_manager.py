...
# Mode constants as defined in C++ LilypadEngine
MODE_OFF = 0
MODE_SMOOTH = 1
MODE_SLOW = 2
MODE_SUPER_SMOOTH = 3
...
MODE_INFO = {
    ...
    MODE_SEQUENCE: {"title": "Sequence", "icon": "input-keyboard"},
}
...
class ModeManagerPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        global_modes = [
            ...
            MODE_SURROUNDING, MODE_PREEDIT, MODE_EMOJI, MODE_SEQUENCE,
            MODE_OFF
        ]
        ...
        grid_modes = [
            ...
            MODE_PREEDIT, MODE_EMOJI, MODE_SEQUENCE,
