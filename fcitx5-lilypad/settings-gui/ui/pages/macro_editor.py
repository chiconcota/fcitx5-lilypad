...
"""
Macro Editor Page. Edits lilypad-macro-table.conf.
...
class MacroEditorPage(BaseEditorPage):
    ...
    def load_data(self):
        ...
        try:
            ...
            data = self.dbus.get_sub_config_list("lilypad-macro", "Macro")
            for item in data:
    ...
    def save_data(self):
        ...
        self.dbus.set_sub_config_list("lilypad-macro", "Macro", data)
        self.initial_state = self._get_current_state()
