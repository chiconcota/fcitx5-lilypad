...
class LilypadSettingsWindow(QMainWindow):
    """Main entry window for Lilypad Configuration GUI."""

    def __init__(self):
        super().__init__()
        self.setWindowTitle(_("Lilypad Settings"))

        self.dbus_handler = LilypadDBusHandler()
