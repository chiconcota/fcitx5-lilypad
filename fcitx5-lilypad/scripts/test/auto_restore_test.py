...
test_paragraph = "Chafo cacs banfj, minhf ddang tesst Lilypad. Smart auto restore: text, expect, perfect, window, with, their, wow, luxury, tesla, life, issue, feature, express, wonderful, support, core, care, saas, sax, push, work, hard, user. Per app memory: VS Code, Slack. Auto disable: Japanese, Korean, Chinese. DDawsk Lawsk, DDawsk Noong, Kroong Buks. Thanks for your wonderful support with thiss software."
expected_output = "Chào các bạn, mình đang test Lilypad. Smart auto restore: text, expect, perfect, window, with, their, wow, luxury, tesla, life, issue, feature, express, wonderful, support, core, care, saas, sax, push, work, hard, user. Per app memory: VS Code, Slack. Auto disable: Japanese, Korean, Chinese. Đắk Lắk, Đắk Nông, Krông Búk. Thanks for your wonderful support with this software."

def run_test():
    print("\n" + "="*50)
    print("        Lilypad Auto-Restore Test (Linux)")
    print("="*50)
    print(f"\n[Input (Telex typing)]:\n\"{test_paragraph}\"")
    print(f"\n[Expected Output]:\n\"{expected_output}\"")
    ...
    print("\n" + "!"*50)
    print(" INSTRUCTIONS:")
    print(" 1. Ensure fcitx5-lilypad is active and in Vietnamese mode.")
