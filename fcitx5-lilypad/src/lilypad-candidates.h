...
/**
 * @file lilypad-candidates.h
 * @brief Candidate word classes for Lilypad input method UI.
 */

#ifndef _FCITX5_LILYPAD_CANDIDATES_H_
#define _FCITX5_LILYPAD_CANDIDATES_H_
...
namespace fcitx {
    ...
    class EmojiCandidateWord : public CandidateWord {
      public:
         ...
         * @param state Pointer to LilypadState.
         * @param entry The emoji entry.
         */
        EmojiCandidateWord(Text text, LilypadState* state, EmojiEntry entry);
...
#endif // _FCITX5_LILYPAD_CANDIDATES_H_
