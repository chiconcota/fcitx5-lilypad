...
/**
 * @file lilypad-monitor.h
 * @brief Input monitoring and timing utilities for fcitx5-lilypad.
 */

#ifndef _FCITX5_LILYPAD_MONITOR_H_
#define _FCITX5_LILYPAD_MONITOR_H_
...
#endif // _FCITX5_LILYPAD_MONITOR_H_
