#ifndef LOTUS_SEQUENCER_H
#define LOTUS_SEQUENCER_H
...
namespace fcitx {
    ...
    struct SequencerConfig {
        ...
        uint64_t max_ack_timeout_ms = 15; // Smart 15ms safety timeout for laggy apps (AFFiNE / BlockSuite / Facebook)
    };
    ...
    class Sequencer {
      ...
      private:
        ...
        uint64_t                              last_measured_ack_ms_ = 1;
    };

} // namespace fcitx

#endif // LOTUS_SEQUENCER_H
